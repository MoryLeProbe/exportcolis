 ...
 */
final class Version20251202135633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expedition ADD CONSTRAINT FK_692907E19EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
